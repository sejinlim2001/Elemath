...
public class Problem20Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problem20, container, false);
        ...
        Button failureButtonN = rootView.findViewById(R.id.problem20FailureButtonN);
        ...
        Button failureButtonBe = rootView.findViewById(R.id.problem20FailureButtonBe);
        ...
        Button failureButtonK = rootView.findViewById(R.id.problem20FailureButtonK);
        ...
        Button successButtonCa = rootView.findViewById(R.id.problem20SuccessButtonCa);
        successButtonCa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (quizProblemFragment.getSelectGame()) {
                    editor.putBoolean("Problem20", true);
                    editor.commit();
                }
            }
        });

        Button backButton20 = rootView.findViewById(R.id.backButton20);
