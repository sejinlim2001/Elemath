...
public class Problem9Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problem9, container, false);
        ...
        Button failureButtonB = rootView.findViewById(R.id.problem9FailureButtonB);
        ...
        Button failureButtonK = rootView.findViewById(R.id.problem9FailureButtonK);
        ...
        Button failureButtonC = rootView.findViewById(R.id.problem9FailureButtonC);
        ...
        Button successButtonF = rootView.findViewById(R.id.problem9SuccessButtonF);
        successButtonF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (quizProblemFragment.getSelectGame()) {
                    editor.putBoolean("Problem9", true);
                    editor.commit();
                }
            }
        });

        Button backButton9 = rootView.findViewById(R.id.backButton9);
