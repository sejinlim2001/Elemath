...
public class Problem19Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problem19, container, false);
        ...
        Button failureButtonH = rootView.findViewById(R.id.problem19FailureButtonH);
        ...
        Button failureButtonB = rootView.findViewById(R.id.problem19FailureButtonB);
        ...
        Button failureButtonF = rootView.findViewById(R.id.problem19FailureButtonF);
        ...
        Button successButtonK = rootView.findViewById(R.id.problem19SuccessButtonK);
        successButtonK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (quizProblemFragment.getSelectGame()) {
                    editor.putBoolean("Problem19", true);
                    editor.commit();
                }
            }
        });

        Button backButton19 = rootView.findViewById(R.id.backButton19);
