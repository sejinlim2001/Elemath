...
public class Problem8Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problem8, container, false);
        ...
        Button failureButtonB = rootView.findViewById(R.id.problem8FailureButtonB);
        ...
        Button failureButtonK = rootView.findViewById(R.id.problem8FailureButtonK);
        ...
        Button failureButtonF = rootView.findViewById(R.id.problem8FailureButtonF);
        ...
        Button successButtonO = rootView.findViewById(R.id.problem8SuccessButtonO);
        successButtonO.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (quizProblemFragment.getSelectGame()) {
                    editor.putBoolean("Problem8", true);
                    editor.commit();
                }
            }
        });

        Button backButton8 = rootView.findViewById(R.id.backButton8);
