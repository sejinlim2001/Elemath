...
public class Problem1Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problem1, container, false);
        ...
        Button successButtonH = rootView.findViewById(R.id.problem1SuccessButtonH);
        successButtonH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (quizProblemFragment.getSelectGame()) {
                    editor.putBoolean("Problem1", true);
                    editor.commit();
                }
            }
        });

        Button failureButtonB = rootView.findViewById(R.id.problem1FailureButtonB);
        ...
        Button failureButtonK = rootView.findViewById(R.id.problem1FailureButtonK);
        ...
        Button failureButtonF = rootView.findViewById(R.id.problem1FailureButtonF);
        ...
        Button backButton1 = rootView.findViewById(R.id.backButton1);
