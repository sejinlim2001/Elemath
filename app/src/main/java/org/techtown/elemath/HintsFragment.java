...
public class HintsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_hints, container, false);

        SoundSet.initSounds(getActivity());

        ProblemsFragment problemsFragment = new ProblemsFragment();
        Button backButtonHints = rootView.findViewById(R.id.backButtonHints);
        backButtonHints.setOnClickListener(new View.OnClickListener() {
            @Override
