...
public class Problem2Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problem2, container, false);
        ...
        Button failureButtonH = rootView.findViewById(R.id.problem2FailureButtonH);
        ...
        Button failureButtonSi = rootView.findViewById(R.id.problem2FailureButtonSi);
        failureButtonSi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Animation animation = AnimationUtils.loadAnimation(getActivity(),R.anim.clickwronganswer);
                view.startAnimation(animation);
                Toast.makeText(getActivity(), "Try again!", Toast.LENGTH_SHORT).show();
                failureButtonSi.setVisibility(View.INVISIBLE);
                SoundSet.play(SoundSet.failSound);
            }
        });

        Button successButtonHe = rootView.findViewById(R.id.problem2SuccessButtonHe);
        successButtonHe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (quizProblemFragment.getSelectGame()) {
                    editor.putBoolean("Problem2", true);
                    editor.commit();
                }
            }
        });

        Button failureButtonF = rootView.findViewById(R.id.problem2FailureButtonF);
