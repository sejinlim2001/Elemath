...
public class Problem7Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problem7, container, false);
        ...
        Button failureButtonBe = rootView.findViewById(R.id.problem7FailureButtonBe);
        ...
        Button failureButtonLi = rootView.findViewById(R.id.problem7FailureButtonLi);
        ...
        Button failureButtonNe = rootView.findViewById(R.id.problem7FailureButtonNe);
        failureButtonNe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Animation animation = AnimationUtils.loadAnimation(getActivity(),R.anim.clickwronganswer);
                view.startAnimation(animation);
                Toast.makeText(getActivity(), "Try again!", Toast.LENGTH_SHORT).show();
                failureButtonNe.setVisibility(View.INVISIBLE);
                SoundSet.play(SoundSet.failSound);
            }
        });

        Button successButtonN = rootView.findViewById(R.id.problem7SuccessButtonN);
        successButtonN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (quizProblemFragment.getSelectGame()) {
                    editor.putBoolean("Problem7", true);
                    editor.commit();
                }
            }
        });

        Button backButton7 = rootView.findViewById(R.id.backButton7);
